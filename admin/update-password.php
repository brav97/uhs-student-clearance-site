              ...
              <br><br>
                ...
                <?php
                    ...
                    if(isset($_POST['change-password'])){
                      ...
                      $confirm_password = mysqli_real_escape_string($conn, $_POST['confirm-new-password']);
                      $password_length = strlen($new_password);

                      if(empty($old_password) || empty($new_password) || empty($confirm_password)){
                          echo "
                              <div class='alert alert-danger alert-dismissible fade show' role='alert'>
                              <strong>Warning!</strong> Provide all details.
                          ...
                          echo "
                              <div class='alert alert-danger alert-dismissible fade show' role='alert'>
                              <strong>Warning!</strong> Provide password of at least 8 characters.
                              <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
                                <span aria-hidden='true'>&times;</span>
                              </button>
                            </div>";
                      ...
                      }else if($old_password !== $adminpassword){
                          echo "
                              <div class='alert alert-danger alert-dismissible fade show' role='alert'>
                        ...
                        $update_details = "UPDATE `admin` SET `password`= '$new_password' WHERE `email` = '$admin'";
                        $query_update = mysqli_query($conn, $update_details);
                        if($query_update){
                ...
                ?>
                              ...
                              <div class="form-group">
                                ...
                                <input type="password" name="old-password" class="form-control form-control-lg">
                              </div>
                              <div class="form-group">
                                <label>New Password</label>
                                <input type="password" name="new-password" class="form-control form-control-lg" minlength="8">
                              </div>
                              <div class="form-group ">
                                <label>Confirm New Password</label>
                                <input type="password" name="confirm-new-password" class="form-control form-control-lg">
                              </div> 
                       
                      
                              
                              <div class="form-group "> 
                                <input type="submit" name="change-password" class="btn btn-danger btn-block btn-lg" value="UPDATE PASSWORD">
                              </div>
                    </form>
                </div>
