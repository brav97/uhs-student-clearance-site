      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">COMPLETED CLEARANCE</h1>
        ...
        <div class="row">
          <div class="table-responsive print-section" style="background-color: white;padding: 50px 30px;">
             <center><h3><b><i>COMPLETED CLEARANCE</i></b></h3></center><hr><br>
             <?php
              include '../db/db-connection.php';
              global $department;
              $status = "WAITING";

              $select = "SELECT * FROM `cleared_students`";
              ...
              if($rows >= 1){
                ...
                while ($data = mysqli_fetch_assoc($query)) { 
                  ...
                  $gender = $data['gender'];
                  $class_admitted = $data['class_admitted'];
  ...
  <script>
    $('#print-receipt').on("click", function () {
      $('.print-section').printThis({
        ...
        pageTitle: "UPPERHILL SCHOOL  CLEARANCE LIST",               
        removeInline: false,         
