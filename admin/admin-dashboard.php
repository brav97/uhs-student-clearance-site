      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" id="print-receipt"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
          </div>
