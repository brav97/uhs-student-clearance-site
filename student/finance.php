...
if(!isset($_SESSION['humanities_dept_cleared']))
{ 
      ...
      <div class="container-fluid">
        ...
        <div class="row jumbotron">
          <div class="col-lg-8 col-md-12 col-xs-12 col-sm-12" style="background-color: white;border:1px solid black;padding: 40px 20px;">
            <h4><b>FINANCE DEPARTMENT CHECKLIST</b></h4><hr><br>
            <?php
              include '../db/db-connection.php';
              global $adm;

              $select = "SELECT * FROM `borrowed_items` WHERE `adm_number` = '$adm' AND `status` = 'BORROWED' AND `department` = 'finance'";
              ...
              if($rows >= 1){
                ...
                while ($data = mysqli_fetch_assoc($query)) { 
                  ...
                  if($status == "WAITING"){
                    ...
                    echo $status;
                    $_SESSION['finance_dept_cleared'] = 'PROCEEDTOSPORTS';
